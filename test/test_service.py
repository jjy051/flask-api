...
def test_generate_access_token(user_service):
    ...
    payload = jwt.decode(token, user_service.config['JWT_SECRET_KEY'], 'HS256')
...
def test_save_and_get_profile_picture(user_service):
    ...
    assert actual_profile_picture == "https://cdn-bucket-for-flask-api.s3.ap-northeast-2.amazonaws.com/test/test.png"